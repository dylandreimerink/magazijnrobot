...
public class Connection implements Runnable{
	...
	public void openConnection(ArrayList <Product> list){
...
//					}
	...
	public void SendCordinates(ArrayList <Product> list){
		for(int i = 0; i < list.size(); i++) {   
		    int intx = list.get(i).GetLocatieX();
		    int inty = list.get(i).GetLocatieY();
